...
\paragraph{Inventory trajectories.}
Figure~\ref{fig:trajectories} shows sample inventory levels over one
episode per method. Base-stock maintains smooth, near-constant inventory
at all three nodes. IDQN and VDN show more volatile trajectories but avoid
prolonged backlog. CDQN exhibits the most erratic behavior, consistent
with its high cost variance. Upstream amplification is visible in the IDQN
panel: the supplier's inventory fluctuates far more than the retailer's
despite identical lead times, illustrating the bullwhip effect in practice.
