...
three RL methods spanning a coordination spectrum—Independent DQN (IDQN),
Centralized DQN (CDQN), and Value Decomposition Networks (VDN)—against
...
when demand shifts—a common real-world scenario from seasonality, market
shocks, or promotions.
...
levels upstream, creating the \emph{bullwhip effect}—amplification of
demand variance as orders propagate upstream \cite{lee1997bullwhip}. A
...
training, but VDN achieves $1.69$ on non-stationary demand—closest to
